...
public class UpdateException extends Exception{
	...
	public UpdateException(Throwable causa){
		super(causa.getMessage());
		this.causa = causa;
	}
	
	public UpdateException(String mensaje, Throwable causa){
		super(mensaje);
		this.causa = causa;
	}
	...
	public String getFormattedException(){
		...
		exception.append("[UpdateException] ");
	...
	public void printStackTrace(PrintStream printStream){
		...
		if(causa != null){
			printStream.println("[UpdateException] Excepción original...");
	...
	public void printStackTrace(PrintWriter printWriter){
		...
		if(causa != null){
			printWriter.println("[UpdateException] Excepción original...");
